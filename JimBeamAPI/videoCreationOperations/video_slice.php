...
define("MOVIE", "11508_42577_a_4.mp4");
define("MOVIE_SLICED", 'getty/Getty-2.mov');
define("MOVIE_SLICE_TIME", '00:00:30');
define("MOVIE_OUT", 'output/out.mp4');
...
//ETF - TAKES SOUND
exec('ffmpeg -i ' . MOVIE_SLICED . ' -ab 160k -ac 2 -ar 44100 -vn output/audio.mp3');
...
//exec('ffmpeg -i ' . MOVIE . '  -b:a 64k -ar 44000 -ac 1 -vn audio.mp3');
//ETF - SPLITS FRAMES
exec('ffmpeg -i ' . MOVIE_SLICED . ' -r 25 -qscale 0 ./output/frames/image-%07d.png');
...
exec('ffmpeg -f image2 -i ./images/image-%07d.png -i ./audio.mp3 -vcodec libx264 -r 30  -b 1000k out.mp4');
$end = microtime(true);
